...
list_train = ['', 'BCA', 'BRI', 'BNI', 'MANDIRI', 'BTN', 'BSI']
list_gender = ['', 'male', 'female']

conn = st.connection("postgresql", type="sql", 
                     url="postgresql://avindalutfiapb17:VNvKwPZaJ32O@ep-snowy-heart-34856175.us-east-2.aws.neon.tech/web?sslmode=require")
    ...
    for _, result in data.iterrows():        
        ...
        with st.expander(f'a.n. {nasabah_name_lama}'):
            with st.form(f'data-{id}'):
                ...
                jenis_tabungan_baru = st.text_input("jenis_tabungan", jenis_tabungan_lama)
